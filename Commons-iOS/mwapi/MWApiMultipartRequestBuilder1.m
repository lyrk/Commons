6#import "MWApiMultipartRequestBuilder.h"
...
@interface MWApiMultipartRequestBuilder () <NSStreamDelegate>
...
- (void)startSend:(NSString *)filePath
{
    ...
    url = [NSURL URLWithString:@"http://localhost:8888/mediawiki/api.php"];
    success = (url != nil);
